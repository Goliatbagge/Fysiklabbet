        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              ...
              { num: '1.2', title: 'Mer kraftmoment', description: 'En bräda på två bockar. Dra i lasten och i stöden och se stödkrafterna F_P och F_Q live. Välj vridningspunkt fritt (vid ett stöd blir dess hävarm 0) och lös ut den andra kraften med momentlagen — och se brädan välta när tyngdpunkten passerar ett stöd.', href: 'fysik2-brada-tva-stod-app.html', icon: '⚖️', keywords: ['krafter','moment','vridmoment','kraftmoment','exempel','jämvikt','vridningspunkt','stöd','stödkraft','bock','bräda','hävarm','tyngdpunkt','linjal','statik','mekanik'] },
