        ...
        chapters: {
          ...
          'Ljus som våg och partikel': {
            ...
            sections: [
              ...
              { num: '4.2', title: 'Ljus, diffraktion och interferens', description: 'Dubbelspalten i 3D: vågytan visar hur de två vågsystemen möts, skärmen fångar mönstret som ljusband eller som partiklar en i taget, gitterformeln n · λ = d · sin α ritas i rummet, och en detektor vid spalterna visar hur banden försvinner så snart vägen observeras. Samma experiment finns också som planvy i 2D.', href: 'fysik2-dubbelspalt-3d-app.html', href2: 'fysik2-dubbelspalt-2d-app.html', icon: '🔬', keywords: ['vågor','optik','ljus','diffraktion','interferens','dubbelspalt','huygens','gitterformeln','laser','våglängd','spaltavstånd','maxima','minima','nodlinje','observation','observatör','detektor','3d'] },
              ...
              { num: '4.6', title: 'Våg-partikeldualitet och de Broglies hypotes', description: 'Materievågor — alla partiklar är också vågor. Skjut elektroner en i taget mot dubbelspalten i 3D eller i planvy, med eller utan detektor vid spalterna, och se mönstret växa fram partikel för partikel.', href: 'fysik2-dubbelspalt-3d-app.html', href2: 'fysik2-dubbelspalt-2d-app.html', icon: '🔬', keywords: ['modern fysik','kvantfysik','dubbelspalt','elektroner','interferens','våg-partikel','våg-partikeldualitet','de broglie','observation'] },
