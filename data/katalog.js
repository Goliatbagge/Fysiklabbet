        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              ...
              { num: '1.5', title: 'Cirkulär rörelse', description: 'En bil i cirkelbana ovanifrån och en bil i loop. Visa verkliga krafter eller centripetalkraften (resultanten), hastighet, centripetalacceleration och radie — och hitta gränsfarten där bilen precis klarar loopen (normalkraften 0 i toppen). Eller tänd tomteblosset i skruvdragaren och se gnistorna lämna banan tangentiellt.', href: 'fysik2-cirkular-rorelse-app.html', href2: 'fysik2-tomtebloss-app.html', icon: '🔄', keywords: ['rörelse','krafter','cirkulär','cirkelbana','centripetal','centripetalkraft','centripetalacceleration','vinkelhastighet','omega','banhastighet','banfart','radie','loop','looping','normalkraft','tyngdkraft','friktion','gränsfart','bil','kurva','mekanik','tomtebloss','centrifug','tvättsvamp','tangent','tangentiellt','tröghet'] },
          ...
          'Ljus som våg och partikel': {
            ...
            sections: [
              ...
              { num: '4.2', title: 'Ljus, diffraktion och interferens', description: 'Dubbelspalten i 3D: vågytan visar hur de två vågsystemen möts, skärmen fångar mönstret som ljusband eller som partiklar en i taget, gitterformeln n · λ = d · sin α ritas i rummet, och en detektor vid spalterna visar hur banden försvinner så snart vägen observeras. Eller skjut elektroner mot dubbelspalten i den klassiska simuleringen med observatör.', href: 'fysik2-dubbelspalt-3d-app.html', href2: 'fysik2-dubbelspalt.html', icon: '🔬', keywords: ['vågor','optik','ljus','diffraktion','interferens','dubbelspalt','huygens','gitterformeln','laser','våglängd','spaltavstånd','maxima','minima','nodlinje','observation','observatör','detektor','3d'] },
              ...
              { num: '4.6', title: 'Våg-partikeldualitet och de Broglies hypotes', description: 'Materievågor — alla partiklar är också vågor. Skjut elektroner mot dubbelspalten, med eller utan observatör, eller se experimentet i 3D där mönstret växer fram partikel för partikel.', href: 'fysik2-dubbelspalt.html', href2: 'fysik2-dubbelspalt-3d-app.html', icon: '🔬', keywords: ['modern fysik','kvantfysik','dubbelspalt','elektroner','interferens','våg-partikel','våg-partikeldualitet','de broglie','observation'] },
