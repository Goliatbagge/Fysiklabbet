        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              ...
              { num: '1.6', title: 'Konisk pendel', description: 'Interaktiv 3D-simulering — vrid, zooma och visa krafter. Kan växlas till jämförelse med harmonisk svängning och plan pendel.', href: 'fysik2-konisk-pendel.html', icon: '🪀', keywords: ['rörelse','konisk pendel','svängning','jämförelse','centripetal','3d','spännkraft','komposanter'] },
              { num: '1.7', title: 'Kaströrelse', description: 'Projektilrörelse och kastparabeln.', href: 'fysik2-rorelse-app.html', icon: '🎯', keywords: ['rörelse','kast','projektil','parabel','snett kast','kinematik','gravitation'] },
