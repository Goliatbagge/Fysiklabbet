    ...
    courses: {
        ...
        chapters: {
          ...
          'Rörelse': {
            ...
            sections: [
              ...
              { num: '2.5', title: 'Acceleration-tid-diagram', description: 'Att läsa hastighetsändring ur ett a-t-diagram.', href: null, icon: '📊', keywords: ['rörelse','kinematik','acceleration','tid','diagram','graf'] },
          ...
          'Krafter': {
            ...
            sections: [
              { num: '3.1', title: 'Kraft och Newtons första lag', description: 'Tröghet — en kropp förblir i vila eller likformig rörelse om resulterande kraft är noll.', href: null, icon: '⚖️', keywords: ['krafter','newton','första lagen','tröghet','jämvikt'] },
              { num: '3.2', title: 'Newtons andra lag', description: 'F = m · a — sambandet mellan kraft, massa och acceleration.', href: null, icon: '➡️', keywords: ['krafter','newton','andra lagen','kraft','massa','acceleration'] },
          ...
          'Energi': {
            ...
            sections: [
              ...
              { num: '4.4', title: 'Energiprincipen', description: 'Energi kan inte skapas eller förstöras, bara omvandlas.', href: null, icon: '♻️', keywords: ['energi','energiprincipen','bevarande'] },
      ...
      'Fysik – fördjupning': {
        ...
        chapters: {
          ...
          'Astronomi': {
            number: 5,
            intro: 'Hur vi tolkar himlavalvet — månens faser och stjärnors färger. Vi använder Wiens förskjutningslag och Rayleighspridning för att förstå vad färgen säger om en himlakropp.',
            sections: [
