        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              ...
              { num: '1.7', title: 'Konisk pendel', description: 'Interaktiv 3D-simulering — vrid, zooma och visa krafter. Kan växlas till jämförelse med harmonisk svängning och plan pendel.', href: 'fysik2-konisk-pendel.html', icon: '🪀', keywords: ['rörelse','konisk pendel','svängning','jämförelse','centripetal','3d','spännkraft','komposanter'] },
              ...
              { num: '1.9', title: 'Exempel — Den flygande kossan', description: 'Räkneexempel: snett kast och rörelseanalys.', href: null, icon: '🐄', keywords: ['rörelse','kast','exempel','projektil'] },
