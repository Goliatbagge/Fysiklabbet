  ...
  },
{
  ...
  },
  {
    id: 'magnon',
    term: 'Magnon',
    former: ['magnon', 'magnonen', 'magnoner', 'magnonerna', 'magnonik', 'magnoniken', 'magnonkrets', 'magnonkretsen', 'magnonkretsar', 'magnonforskning', 'magnonforskningen', 'magnondynamik', 'magnondynamiken', 'fyrmagnonspridning', 'fyrmagnonspridningen', 'magnonriktning', 'magnonriktningar'],
    ...
    relaterade: ['spinnvag', 'spinn', 'fonon', 'altermagnetism', 'skyrmion'],
    body: [
  ...
  },
  {
    id: 'fresnellins',
    term: 'Fresnellins',
    former: ['fresnellins', 'fresnellinsen', 'fresnellinser', 'fresnellinserna'],
    kort: 'En lins som delats upp i tunna ringar och plattats till, så att den samlar ljus nästan som en tjock glaslins men väger en bråkdel. Uppfanns för fyrarna på 1820-talet och sitter i dag i allt från strålkastare till solkoncentratorer.',
    relaterade: ['optisk-fiber', 'diffraktion'],
    body: [
      { type: 'p', html: 'En vanlig samlingslins bryter ljuset vid sina två ytor, och det är ytornas lutning som bestämmer åt vilket håll varje stråle viker av. Glaset därinne gör ingen nytta för brytningen. Det tillför bara vikt, och en riktigt stor lins skulle dessutom suga upp en del av ljuset på vägen genom den tjocka mitten. Den franske fysikern Augustin Fresnel insåg på 1820-talet att man kan behålla ytan men slänga glaset: dela in linsen i ett antal ringar, ge varje ring samma lutning som motsvarande del av den tjocka linsen, och flytta ner alla ringarna på en gemensam tunn skiva. Resultatet ser ut som en platta med koncentriska trappsteg, men varje trappsteg bryter ljuset precis som den bit av den ursprungliga linsen det ersätter.' },
      { type: 'p', html: 'Fresnel byggde sin lins för fyrarna, där problemet var att en oljelåga syns dåligt på långt håll om inte ljuset samlas till en stråle. En glaslins stor nog att göra det hade vägt flera ton och varit omöjlig att gjuta utan blåsor och sprickor. Den första fresnellinsen sattes upp i fyren Cordouan vid Frankrikes atlantkust 1823 och sågs på flera mils avstånd. Inom några decennier hade nästan alla fyrar i världen fått samma lösning, i form av väldiga glasringar sammansatta i en mässingsram runt lågan.' },
      { type: 'p', html: 'Priset man betalar är bildskärpan. Vid varje trappsteg bryts en del av ljuset lite fel, och en fresnellins ger därför en suddigare bild än en slipad kameralins. Det spelar ingen roll när uppgiften bara är att samla eller sprida ljus, vilket är just vad de flesta linser gör. Därför sitter fresnellinser i dag i strålkastare, bilarnas lyktor, overheadapparater, förstoringsglas av plast i fickformat och de stora skivor som koncentrerar solljus till en brännpunkt. Moderna exemplar pressas i plast och kan göras över en meter stora utan att väga mer än några kilogram. En sådan lins på 1,4&nbsp;m<sup>2</sup> fångar lika mycket solljus som en jämnstor glaslins, som hade behövt vara flera decimeter tjock i mitten.' }
    ]
  },
  {
    id: 'spinnvag',
    term: 'Spinnvåg',
    former: ['spinnvåg', 'spinnvågen', 'spinnvågor', 'spinnvågorna', 'spinnvågsmod', 'spinnvågsmoder', 'spinnvågsmoden'],
    kort: 'En krusning som vandrar genom ett magnetiskt material utan att någon atom flyttar sig. Det som färdas är atomernas magnetiska riktning, som vickar runt i takt med grannarnas, lite förskjuten från atom till atom.',
    relaterade: ['magnon', 'spinn', 'fonon', 'yttriumjarngranat'],
    body: [
      { type: 'p', html: 'I en magnet bär varje atom ett spinn, en liten inbyggd magnet med en egen riktning, och i ett välordnat material pekar de alla åt samma håll. Riktningarna sitter inte fast. Knuffar man en av dem ur sitt läge börjar den vicka runt sin ursprungliga riktning, ungefär som en snurra som lutar och gungar runt lodlinjen i stället för att falla omkull. Mellan grannatomerna verkar dessutom en kraft som vill hålla deras spinn parallella, så en atom som vickar drar grannen med sig, och grannen drar nästa. Vickandet vandrar därför vidare genom materialet med en liten fördröjning för varje atom, och det är den vandrande rörelsen som kallas spinnvåg. Läser man av riktningarna längs en rad atomer ser man ett vågmönster, precis som en ögonblicksbild av en vattenyta, men ingen materia och ingen laddning flyttar sig.' },
