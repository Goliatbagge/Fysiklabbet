...
{ num: '2.5', title: 'Derivatan av sin x och cos x', description: 'Trigonometriska funktioner deriveras: D(sin x) = cos x och D(cos x) = −sin x när vinkeln mäts i radianer. Kombineras med kedjeregeln, t.ex. D(sin kx) = k cos kx.', href: null, icon: null, keywords: ['derivata', 'trigonometriska funktioner', 'sinus', 'cosinus', 'radianer', 'kedjeregeln', 'deriveringsregler', 'derivatan av sin x', 'derivatan av cos x'] },
