...
window.KATALOG = {
    ...
    courses: {
      'Fysik nivå 1': {
        ...
        chapters: {
          'Introduktion': {
            number: 1,
            intro: 'Vad fysik handlar om och hur vi mäter världen runt oss. Du lär dig det vetenskapliga arbetssättet, SI-systemets grundenheter och hur prefix och grundpotensform gör stora och små tal hanterbara.',
            sections: [
              ...
              { num: '1.2', title: 'Storheter, enheter och prefix', description: 'SI-systemet, grundenheter och prefix från piko till tera.', href: null, icon: '📏', keywords: ['si-enheter','enheter','storheter','prefix','beteckningar'] },
              { num: '1.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — SI-systemets grundenheter från meter till candela.', href: 'fysik-enhetskoll.html#fy1-1', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','grundenheter','quiz'] },
              { num: '1.S', title: 'Sammanfattning', description: 'Kapitlets begrepp, formler och viktigaste samband — komprimerat inför provet, med repetitionsspel.', href: 'fysik-repetition.html#fy1-1', icon: '∑', keywords: ['sammanfattning','repetition','prov','provkoll','formler','si-enheter','prefix','storheter','enheter'] },
            ],
          },
          'Rörelse': {
            number: 2,
            intro: 'Hur saker rör sig — sträcka, fart, hastighet och acceleration. Vi börjar med medelfart, lär oss tolka rörelsediagram och formulera sambanden mellan dem, från konstant hastighet till accelererad rörelse och fritt fall.',
            sections: [
              { num: '2.1', title: 'Medelfart', description: 'Sträcka delat med tid — det första rörelsebegreppet.', href: null, icon: '🏃', keywords: ['rörelse','kinematik','medelfart','hastighet','tid'] },
              { num: '2.2', title: 'Vektoraddition', description: 'Addera två hastighetsvektorer geometriskt — med triangel- eller parallellogrammetoden. Dra i pilspetsarna.', href: 'fysik1-vektoraddition-app.html', icon: '➡️', keywords: ['vektor','vektoraddition','komposant','resultant','triangelmetoden','parallellogrammetoden','hastighet','geometri','riktning','fart'] },
              { num: '2.3', title: 'Läge-tid-diagram', description: 'Att läsa läge och hastighet ur ett s-t-diagram.', href: 'fysik1-stracka-tid-app.html', icon: '📈', keywords: ['rörelse','kinematik','läge','sträcka','tid','diagram','graf','hastighet'] },
              { num: '2.4', title: 'Acceleration och fritt fall', description: 'Vänd två glasrör med ett rosenblad och ett mynt — och se hur luftmotståndet försvinner i vakuum. Växla även till tyngdfaktorn g på jorden.', href: 'fysik1-tyngdfaktor-jorden.html', icon: '🪶', keywords: ['rörelse','acceleration','fritt fall','g','tyngdacceleration','gravitation','luftmotstånd','vakuum','vakuumpump','rosenblad','mynt','fjäder','galilei'] },
              { num: '2.5', title: 'Hastighet-tid-diagram', description: 'Att läsa acceleration och tillryggalagd sträcka ur ett v-t-diagram.', href: 'fysik1-hastighet-tid-app.html', icon: '📉', keywords: ['rörelse','kinematik','hastighet','tid','diagram','graf','acceleration'] },
              { num: '2.6', title: 'Acceleration-tid-diagram', description: 'Att läsa hastighetsändring ur ett a-t-diagram — arean mellan grafen och tidsaxeln ger Δv.', href: 'fysik1-acceleration-tid-app.html', icon: '📊', keywords: ['rörelse','kinematik','acceleration','tid','diagram','graf','area','hastighetsändring'] },
              { num: '2.7', title: 'Rörelse med konstant acceleration', description: 'Rörelseformlerna och hur de hänger ihop med diagrammen.', href: 'fysik1-rorelsediagram.html', icon: '🚀', keywords: ['rörelse','kinematik','konstant acceleration','formler','fritt fall','kast'] },
              { num: '2.8', title: 'Lösa ekvationssystem i GeoGebra', description: 'Att använda GeoGebra för att lösa ekvationssystem i fysikproblem.', href: null, icon: '🖥️', keywords: ['geogebra','ekvationssystem','verktyg','digitalt'] },
              { num: '2.9', title: 'Torricellis ekvation', description: 'Sambandet mellan hastighet, acceleration och sträcka utan tid.', href: null, icon: '⚗️', keywords: ['torricelli','kinematik','rörelse','ekvation'] },
              { num: '2.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — sträcka, hastighet, acceleration och tid.', href: 'fysik-enhetskoll.html#fy1-2', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','rörelse','kinematik','quiz'] },
              { num: '2.S', title: 'Sammanfattning', description: 'Rörelsediagrammen och formlerna för konstant acceleration — komprimerat inför provet, med repetitionsspel.', href: 'fysik-repetition.html#fy1-2', icon: '∑', keywords: ['sammanfattning','repetition','prov','provkoll','formler','rörelse','kinematik','medelfart','diagram','acceleration'] },
            ],
          },
          'Krafter': {
            number: 3,
            ...
            sections: [
              ...
              { num: '3.3', title: 'Newtons tredje lag', description: 'Aktion och reaktion — navigera med brandsläckare i rymden, eller väg en flygande fluga i en bägare.', href: 'fysik1-newtons-tredje-app.html', href2: 'fysik1-flugan-i-bagaren-app.html', icon: '🚀', keywords: ['krafter','newton','tredje lagen','aktion','reaktion','motkraft','rymd','raket','impuls','fluga','bägare','våg','mekanik'] },
          ...
          'Energi': {
            ...
            sections: [
              ...
              { num: '4.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — energi, arbete, effekt, rörelsemängd och impuls.', href: 'fysik-enhetskoll.html#fy1-4', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','energi','arbete','effekt','quiz'] },
          ...
          'Tryck': {
            ...
            sections: [
              ...
              { num: '5.5', title: 'Lyftkraft och Arkimedes princip', description: 'Flyta eller sjunka — släpp och tryck ner block i olika vätskor, eller mät lyftkraften med dynamometer.', href: 'fysik1-flytkraft-app.html', href2: 'fysik1-arkimedes.html', icon: '⚖️', keywords: ['arkimedes','lyftkraft','flytkraft','densitet','vätska','vatten','dynamometer','flyta','sjunka','flytförmåga','undanträngd'] },
              { num: '5.6', title: 'Gasers lyftkraft', description: 'Varför varmluftballonger och vätgasballonger lyfter.', href: null, icon: '🎈', keywords: ['tryck','gas','lyftkraft','ballong','densitet'] },
              { num: '5.7', title: 'Ideala gaslagen och kelvinskalan', description: 'Sambandet mellan tryck, volym och temperatur i en gas.', href: 'fysik1-tryck.html', icon: '💨', keywords: ['tryck','gas','ideala gaslagen','volym','temperatur','kelvin','termodynamik','molekyler'] },
              { num: '5.8', title: 'Pascals princip', description: 'Tryck fortplantas oförändrat i en vätska — hydraulik.', href: null, icon: '🛠️', keywords: ['tryck','pascal','hydraulik','vätska'] },
              { num: '5.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — densitet, tryck, volym och area.', href: 'fysik-enhetskoll.html#fy1-5', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','tryck','densitet','quiz'] },
              { num: '5.S', title: 'Sammanfattning', description: 'Densitet, tryck, lyftkraft och gaslagar — komprimerat inför provet, med repetitionsspel.', href: 'fysik-repetition.html#fy1-5', icon: '∑', keywords: ['sammanfattning','repetition','prov','provkoll','formler','densitet','tryck','arkimedes','gaslagen','lyftkraft'] },
            ],
          },
          'Värmelära': {
            number: 6,
            ...
            sections: [
              ...
              { num: '6.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — värmeenergi, specifik värmekapacitet och temperatur.', href: 'fysik-enhetskoll.html#fy1-6', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','värme','värmelära','quiz'] },
          ...
          'Elektricitet': {
            ...
            sections: [
              ...
              { num: '7.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — ström, laddning, spänning, resistans och fältstyrka.', href: 'fysik-enhetskoll.html#fy1-7', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','ellära','elektricitet','quiz'] },
          ...
          'Relativitetsteori': {
            ...
            sections: [
              ...
              { num: '8.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — ljusfarten, viloenergi och vilomassa.', href: 'fysik-enhetskoll.html#fy1-8', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','relativitet','modern fysik','quiz'] },
          ...
          'Kärnfysik': {
            ...
            sections: [
              ...
              { num: '9.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — aktivitet, halveringstid och stråldoser.', href: 'fysik-enhetskoll.html#fy1-9', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','kärnfysik','strålning','quiz'] },
      ...
      'Fysik nivå 2': {
        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              { num: '1.1', title: 'Kraftmoment', description: 'En gungbräda i jämvikt. Placera flera vikter, dra i dem och justera massa och placering med glidare eller exakta värden. Visa tyngdkrafter och hävarmar och se när momentet moturs balanserar momentet medurs (M = F · l).', href: 'fysik2-kraftmoment-app.html', href2: 'fysik2-skiftnyckel-app.html', icon: '🔧', keywords: ['krafter','kraftmoment','vridmoment','moment','hävarm','hävstång','gungbräda','jämvikt','vridning','torque','statik','vågrät','balans','mekanik','skiftnyckel','riktningslinje','angreppspunkt','mutter'] },
              { num: '1.2', title: 'Mer kraftmoment', description: 'En bräda på två bockar. Dra i lasten och i stöden och se stödkrafterna F_P och F_Q live. Välj vridningspunkt fritt (vid ett stöd blir dess hävarm 0) och lös ut den andra kraften med momentlagen — och se brädan välta när tyngdpunkten passerar ett stöd.', href: 'fysik2-brada-tva-stod-app.html', icon: '⚖️', keywords: ['krafter','moment','vridmoment','kraftmoment','exempel','jämvikt','vridningspunkt','stöd','stödkraft','bock','bräda','hävarm','tyngdpunkt','linjal','vältning','statik','mekanik'] },
              { num: '1.3', title: 'Stabilitet', fordjupning: true, description: 'Fördjupning om jämvikt: stödytan och tyngdpunktens lodlinje avgör om ett föremål står kvar eller välter. Vältningsvinkeln för en kloss, de tre jämviktstyperna stabil, labil och indifferent, och balanstricken där tyngdpunkten hamnar under stödpunkten: gafflarna på nålspetsen och dubbelkonen som rullar uppför.', href: 'fysik2-gaffelbalans-app.html', href2: 'fysik2-dubbelkon-app.html', icon: '🤸', keywords: ['krafter','stabilitet','vältning','jämvikt','stabil jämvikt','labil jämvikt','indifferent jämvikt','stödyta','tyngdpunkt','lodlinje','vältningsvinkel','balans','balanstrick','gaffel','kork','nål','mynt','dubbelkon','rullar uppför','lindansare','flaskhållare','fördjupning','statik','mekanik'] },
              { num: '1.4', title: 'Period, frekvens, radianer och vinkelhastighet', description: 'En punkt i cirkelbana kopplad till en svängande punkt och en y–t-graf. Dra i de sammanlänkade reglagen för T, f och ω och se hur de hänger ihop (T = 1/f, ω = 2π/T), visa vinkeln i radianer, cirkelbågen och farten v = ω · r.', href: 'fysik2-vinkelhastighet-app.html', icon: '🌀', keywords: ['rörelse','cirkulär','cirkelrörelse','period','frekvens','hertz','radian','radianer','vinkelhastighet','omega','varv','båglängd','svängning','harmonisk','sinus','fart','mekanik'] },
              { num: '1.5', title: 'Cirkulär rörelse', description: 'En bil i cirkelbana ovanifrån, en bilbana med en vid och en snäv kurva, en bil i loop och en bil över krön och genom dal. Visa verkliga krafter eller centripetalkraften (resultanten), hastighet, centripetalacceleration och radie. Se att kraften bara behövs i kurvorna, hitta gränsfarten där bilen klarar loopen eller lättar från krönet, och sänk friktionen tills bilen fortsätter rakt fram. Eller tänd tomteblosset i skruvdragaren och se gnistorna lämna banan tangentiellt.', href: 'fysik2-cirkular-rorelse-app.html', href2: 'fysik2-tomtebloss-app.html', icon: '🔄', keywords: ['rörelse','krafter','cirkulär','cirkelbana','centripetal','centripetalkraft','centripetalacceleration','vinkelhastighet','omega','banhastighet','banfart','radie','loop','looping','normalkraft','tyngdkraft','friktion','gränsfart','bil','kurva','bilbana','krön','dal','svacka','friktionstal','sladd','grepp','mekanik','tomtebloss','centrifug','tvättsvamp','tangent','tangentiellt','tröghet'] },
              { num: '1.6', title: 'Energi och gravitation i cirkelbanor', description: 'Cirkulär rörelse kombinerad med energiprincipen och Newtons gravitationslag. Repetition från Fysik nivå 1, gungan som ska klara ett helt varv, rymdteleskopet Hubbles banhöjd och Newtons måntest. Simulering: skjut upp en satellit runt jorden och se om banan blir en cirkel, en ellips, en krasch eller en flykt.', href: 'fysik2-satellitbana-app.html', icon: '🛰️', keywords: ['rörelse','krafter','cirkulär','cirkelbana','centripetalkraft','energiprincipen','lägesenergi','rörelseenergi','mekanisk energi','gravitationslagen','newtons gravitationslag','gravitationskraft','gravitationskonstanten','satellit','satellitbana','omloppsbana','hubble','rymdteleskop','banhöjd','gunga','spännkraft','måntest','månen','mekanik','flykthastighet','ellipsbana','perigeum','apogeum','geostationär','iss','rymdstation','gps','krasch'] },
              { num: '1.7', title: 'Konisk pendel', description: 'Interaktiv 3D-simulering — vrid, zooma och visa krafter. Kan växlas till jämförelse med harmonisk svängning och plan pendel.', href: 'fysik2-konisk-pendel.html', icon: '🪀', keywords: ['rörelse','konisk pendel','svängning','jämförelse','centripetal','3d','spännkraft','komposanter','tyngdacceleration','flygande kossan','laboration'] },
              { num: '1.8', title: 'Kaströrelse', description: 'Projektilrörelse och kastparabeln.', href: 'fysik2-rorelse-app.html', icon: '🎯', keywords: ['rörelse','kast','projektil','parabel','snett kast','kinematik','gravitation'] },
              { num: '1.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — kraftmoment, period, frekvens och vinkelhastighet.', href: 'fysik-enhetskoll.html#fy2-1', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','kraftmoment','cirkulär rörelse','quiz'] },
          ...
          'Mekaniska vågor': {
            ...
            sections: [
              ...
              { num: '2.6', title: 'Resonans', description: 'Drivna svängningar och fenomenet resonans.', href: 'fysik2-resonans-app.html', icon: '📣', keywords: ['vågor','svängning','resonans','driven','frekvens','egenfrekvens','tvungen svängning','drivfrekvens','dämpning','resonanskurva','amplitud','gunga','tacoma'] },
              ...
              { num: '2.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — fjäderkonstant, våglängd, intensitet och ljudnivå.', href: 'fysik-enhetskoll.html#fy2-2', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','vågor','svängning','ljud','quiz'] },
          ...
          'Elektromagnetism': {
            ...
            sections: [
              { num: '3.1', title: 'Magnetism och magnetfält', description: 'Permanentmagneter, fältlinjer och kompassens funktion — stavmagnetens fält i 2D och 3D, och attraktion och repulsion mellan två magneter.', href: 'fysik2-stavmagnet-app.html', href2: 'fysik2-magnetpoler-app.html', icon: '🧲', keywords: ['elektromagnetism','magnetism','magnetfält','permanentmagnet','stavmagnet','kompass','kompassnål','fältlinjer','järnfilspån','nordpol','sydpol','poler','attraktion','repulsion'] },
              ...
              { num: '3.13', title: 'Virvelströmmar', description: 'En aluminiumpendel svänger genom ett magnetfält och bromsas in av inducerade virvelströmmar — enligt Lenz lag motverkar de alltid sin orsak. Justera flödestätheten, slå av elektromagneten mitt i svängningen och byt till en platta med spår för att se bromsningen nästan försvinna. Rörelseenergin blir värme, precis som i en induktionshäll. I avsnittets andra simulering släpps två likadana magneter samtidigt, en genom ett kopparrör och en genom ett plaströr. Magneten i kopparröret sjunker som genom sirap.', href: 'fysik2-virvelstrommar-app.html', href2: 'fysik2-magnetror-app.html', icon: '🔥', keywords: ['elektromagnetism','virvelström','virvelströmmar','induktion','lenz','lenz lag','broms','magnetbroms','induktionshäll','induktionsspis','pendel','aluminium','platta','spår','värme','flöde','kopparrör','fallande magnet','gränshastighet'] },
              ...
              { num: '3.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — flödestäthet, magnetiskt flöde och inducerad spänning.', href: 'fysik-enhetskoll.html#fy2-3', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','elektromagnetism','magnetism','quiz'] },
          ...
          'Ljus som våg och partikel': {
            ...
            sections: [
              ...
              { num: '4.2', title: 'Ljus, diffraktion och interferens', description: 'Dubbelspalten i 3D: vågytan visar hur de två vågsystemen möts, skärmen fångar mönstret som ljusband eller som partiklar en i taget, gitterformeln n · λ = d · sin α ritas i rummet, och en detektor vid spalterna visar hur banden försvinner så snart vägen observeras. Växla fritt mellan 3D och planvy ovanifrån.', href: 'fysik2-dubbelspalt.html', icon: '🔬', keywords: ['vågor','optik','ljus','diffraktion','interferens','dubbelspalt','huygens','gitterformeln','laser','våglängd','spaltavstånd','maxima','minima','nodlinje','observation','observatör','detektor','tankeexperiment','planvy','3d','2d'] },
              ...
              { num: '4.6', title: 'Våg-partikeldualitet och de Broglies hypotes', description: 'Materievågor — alla partiklar är också vågor. Skjut elektroner en i taget mot dubbelspalten, i 3D eller i planvy ovanifrån, med eller utan detektor vid spalterna, och se mönstret växa fram partikel för partikel.', href: 'fysik2-dubbelspalt.html', icon: '🔬', keywords: ['modern fysik','kvantfysik','dubbelspalt','elektroner','interferens','våg-partikel','våg-partikeldualitet','de broglie','observation'] },
              ...
              { num: '4.E', title: 'Enhetskoll', description: 'Quiz på kapitlets storheter, enheter och beteckningar — fotonenergi, Plancks konstant, våglängd och brytningsindex.', href: 'fysik-enhetskoll.html#fy2-4', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','si-enheter','ljus','kvantfysik','optik','quiz'] },
          ...
          'Astronomi': {
            ...
            sections: [
              ...
              { num: '5.3', title: 'Månens faser och förmörkelser', description: 'Månens position i banan ger de olika månfaserna — och när sol, jord och måne hamnar på linje blir det sol- eller månförmörkelse.', href: 'fysik2-manens-faser.html', href2: 'fysik2-solformorkelse.html', icon: '🌙', keywords: ['astronomi','måne','faser','omloppsbana','jorden','sol','3d','solförmörkelse','månförmörkelse','förmörkelse','korona','totalitet','kärnskugga','halvskugga','umbra','penumbra','blodmåne','ringformig','vinkeldiameter','nod','ekliptikan','saros'] },
              ...
              { num: '5.5', title: 'Svarta hål', description: 'Flykthastighet, händelsehorisont och Schwarzschildradien.', href: 'fysik2-neutronstjarna.html', icon: '🕳️', keywords: ['astronomi','svart hål','svarta hål','händelsehorisont','schwarzschild','flykthastighet','gravitation','singularitet','supernova','neutronstjärna','relativitet','gravitationsvågor'] },
              ...
              { num: '5.E', title: 'Enhetskoll', description: 'Quiz på kapitlets enheter — ljusår, astronomisk enhet, parsec och bågsekunder.', href: 'fysik-enhetskoll.html#fy2-5', icon: '✓', keywords: ['enhetskoll','enheter','storheter','beteckningar','ljusår','parsec','astronomi','quiz'] },
  ...
  'Matematik': {
    ...
    courses: {
        ...
        chapters: {
          ...
          'Algebra och ekvationer': {
            ...
            sections: [
              ...
              { num: '2.6', title: 'Variabler i båda led', description: 'Samla variablerna på ena sidan och lös ekvationen som vanligt. Och ekvationer som saknar lösning eller har oändligt många lösningar.', href: null, icon: null, keywords: ['algebra','ekvation','variabler i båda led','saknar lösning','oändligt många lösningar','motsägelse','koefficient'] },
      ...
      // Matematik fortsättning nivå 2 (Ma4) byggs ut avsnitt för avsnitt
      // från den samlade genomgångs-PDF:en i Genomgångar/Matematik
      // fortsättning nivå 2/ — se .claude/matematik-4-plan.md för plan,
      // sidmappning och status. Avsnitt läggs in här FÖRST när teori +
      // övningar + exit ticket är klara. Inga simuleringar för matte —
      // href: null, icon: null.
      'Matematik fortsättning nivå 2': {
        ...
        intro: {
          ...
          bullets: [
            'Du lär dig: trigonometriska funktioner, deriveringsregler, integraler och komplexa tal',
            'Du tränar på: trigonometriska ekvationer, kurvanalys och räkning i polär form',
            'Du möter: enhetscirkeln, kedjeregeln, rotationskroppar och de Moivres formel',
          ],
        },
        chapters: {
          'Trigonometri': {
            number: 1,
            intro: 'Trigonometrin lämnar de rätvinkliga trianglarna och flyttar in i enhetscirkeln, där vinklar mäts i både grader och radianer och sinus, cosinus och tangens definieras för alla vinklar. Vi löser trigonometriska ekvationer, härleder additions- och subtraktionsformlerna och trigonometriska ettan, och avslutar med funktionernas grafer — amplitud, period och förskjutning.',
            sections: [
              { num: '1.1', title: 'Trigonometri i rätvinkliga trianglar', description: 'Repetition från Matematik nivå 1c: motstående och närliggande katet, sinus, cosinus, tangens och de inversa funktionerna.', href: null, icon: null, keywords: ['trigonometri','rätvinklig triangel','hypotenusa','katet','motstående katet','närliggande katet','sinus','cosinus','tangens','invers','arcsin','arccos','arctan','vinkel'] },
{ num: '1.2', title: 'Enhetscirkeln', description: 'Enhetscirkeln (radie 1, medelpunkt i origo): sinus som punktens *y*-koordinat, cosinus som *x*-koordinat och tangens som kvoten. Vinklar över 360° och negativa vinklar samt exakta värden för standardvinklarna.', href: null, icon: null, keywords: ['enhetscirkel','sinus','cosinus','tangens','vinkel','koordinat','moturs','negativ vinkel','exakta värden','standardvinklar','trigonometri'] },
{ num: '1.3', title: 'Lösa trigonometriska ekvationer', description: 'Repetition: lös ekvationer som cos x = 0,8 med räknarens invers och ta fram samtliga lösningar — en trigonometrisk ekvation har oändligt många lösningar via periodiciteten (+ n·360° respektive + n·180°).', href: null, icon: null, keywords: ['trigonometriska ekvationer','samtliga lösningar','oändligt många lösningar','period','periodicitet','sinus','cosinus','tangens','inversa funktioner','grundlösning','enhetscirkeln','n·360°'] },
{ num: '1.4', title: 'Mer om trigonometriska ekvationer', description: 'Lösningar i ett givet intervall (pröva vilka heltal n som passar), nollproduktmetoden för produkter som sin(2x)·cos(3x) = 0 och tan-knepet för att eliminera en term.', href: null, icon: null, keywords: ['trigonometri','trigonometriska ekvationer','intervall','periodterm','samtliga lösningar','nollproduktmetoden','produkt lika med noll','tangens','eliminera term','heltal n','grader'] },
{ num: '1.5', title: 'Radianer', description: 'Ett nytt vinkelmått: 1 radian som båge lika lång som radien, sambandet $180^\\circ = \\pi$ rad och omvandling mellan grader och radianer, samt att lösa trigonometriska ekvationer med svar i radianer.', href: null, icon: null, keywords: ['radianer','grader','vinkelmått','enhetscirkel','omvandling','pi','helt varv','trigonometriska ekvationer','räknare','geogebra'] },
{ num: '1.6', title: 'Samband mellan vinklar i enhetscirkeln', description: 'Komplementvinklar och speglingssamband i enhetscirkeln: sin(90°−v) = cos v, sin(v+90°) = cos v, cos(v+180°) = −cos v, negativa vinklar och vinklar över 360°.', href: null, icon: null, keywords: ['enhetscirkel','komplementvinklar','samband mellan vinklar','spegling','symmetri','sinus','cosinus','negativa vinklar','radianer','trigonometri'] },
{ num: '1.7', title: 'Trigonometriska ettan', description: 'Sambandet att sinus i kvadrat plus cosinus i kvadrat för en vinkel är 1, härlett med Pythagoras sats i enhetscirkeln — och hur du bestämmer sin v eller cos v när den andra är känd, med kvadranten som teckenval.', href: null, icon: null, keywords: ['trigonometri','trigonometriska ettan','sinus','cosinus','pythagoras','enhetscirkeln','kvadrant','identitet','omskrivning'] },
{ num: '1.8', title: 'Additions- och subtraktionsformler', description: 'Formlerna för sinus och cosinus av en summa eller skillnad av två vinklar, med geometriskt bevis i enhetscirkeln, formler för dubbla vinkeln och beräkning av exakta värden.', href: null, icon: null, keywords: ['additionsformler', 'subtraktionsformler', 'trigonometri', 'sinus', 'cosinus', 'dubbla vinkeln', 'exakta värden', 'enhetscirkel', 'trigonometriska identiteter', 'bevis'] },
{ num: '1.9', title: 'Formler och trigonometriska ekvationer', description: 'Skriv om och lös trigonometriska ekvationer med additions-/subtraktionsformlerna, dubbla vinkeln och trigonometriska ettan — Fall 1/Fall 2, nollproduktmetoden och substitution.', href: null, icon: null, keywords: ['trigonometriska ekvationer','dubbla vinkeln','additionsformler','trigonometriska ettan','nollproduktmetoden','substitution','pq-formeln','radianer','allmän lösning'] },
{ num: '1.10', title: 'Sinus- och cosinusfunktionen', description: 'Sinus- och cosinusfunktionernas grafer: periodiska med perioden 360° (2π) och värdemängden −1 ≤ y ≤ 1 — samt grafisk lösning av trigonometriska ekvationer.', href: null, icon: null, keywords: ['trigonometri','sinusfunktionen','cosinusfunktionen','graf','periodisk','period','värdemängd','enhetscirkel','trigonometrisk ekvation','grafisk lösning','radianer','grader'] },
{ num: '1.11', title: 'Amplitud och period', description: 'Hur koefficienterna i $y = A \\sin Bx$ formar kurvan: amplituden $|A|$ som höjd, perioden $360^\\circ/B$ (eller $2\\pi/B$), spegling vid negativ koefficient och division i argumentet.', href: null, icon: null, keywords: ['amplitud','period','sinuskurva','trigonometrisk funktion','koefficient','spegling','y = A sin Bx','svängning','radianer','grader','maximivärde','minimivärde'] },
{ num: '1.12', title: 'Förskjutning i *x*- och *y*-led', description: 'Konstanterna C och D i y = sin(x + C) + D flyttar sinuskurvan i sidled och höjdled — med teckenregeln C > 0 åt vänster, C < 0 åt höger.', href: null, icon: null, keywords: ['trigonometri','förskjutning','sinuskurva','cosinuskurva','x-led','y-led','translation','faskonstant','jämviktsläge','graf','amplitud','period'] },
...
{ num: '1.S', title: 'Sammanfattning', description: 'Enhetscirkeln, radianer, trigonometriska formler och sinuskurvans parametrar — kapitlets begrepp, formler och metoder komprimerat inför provet.', href: null, icon: null, keywords: ['sammanfattning','repetition','prov','provkoll','formler','trigonometri','enhetscirkeln','radianer','trigonometriska ekvationer','amplitud','period'] },
          ...
          'Derivata': {
            number: 2,
            intro: 'Derivatan repeteras och utvidgas till nya funktionstyper. Vi deriverar sammansatta funktioner med kedjeregeln, produkter och kvoter med produkt- och kvotregeln, och tar fram derivatan av trigonometriska, exponential- och logaritmfunktioner. Med de nya reglerna löser vi extremvärdesproblem och konstruerar kurvor — och undersöker asymptoter: vertikala, horisontella och sneda.',
            sections: [
{ num: '2.1', title: 'Derivatans definition och deriveringsregler', description: 'Repetition från Matematik fortsättning nivå 1c: derivatans definition som ett gränsvärde, deriveringsregler för potenser och summor, Leibniz-notationen dy/dx samt andraderivatan och hur man deriverar en funktion två gånger.', href: null, icon: null, keywords: ['derivata','derivatans definition','gränsvärde','deriveringsregler','potensregeln','andraderivata','leibniz','derivatans värde','exponentialfunktion','term för term'] },
{ num: '2.2', title: 'Tolkningar av derivata', description: 'Derivatan tolkad som tangentens lutning i en punkt och som momentan förändringshastighet — och hur man bestämmer tangentens ekvation y = kx + m i en given punkt.', href: null, icon: null, keywords: ['derivata', 'tangent', 'tangentens lutning', 'k-värde', 'riktningskoefficient', 'förändringshastighet', 'momentan hastighet', 'räta linjens ekvation', 'tolkning', 'enhet'] },
{ num: '2.3', title: 'Derivatan av sammansatta funktioner och kedjeregeln', description: 'Yttre och inre funktion samt kedjeregeln för att derivera sammansatta funktioner — med kontroll via utveckling samt exponential- och rotfunktioner.', href: null, icon: null, keywords: ['kedjeregeln', 'sammansatt funktion', 'derivata', 'yttre funktion', 'inre funktion', 'inre derivata', 'yttre derivata', 'derivering', 'rotfunktion', 'exponentialfunktion'] },
{ num: '2.4', title: 'Tillämpningar av kedjeregeln', description: 'Kedjeregeln skriven med Leibniz notation, dy/dx = dy/dz · dz/dx, tillämpad på relaterade förändringshastigheter — hur en oljefläcks area och en klotformad ballongs radie ändras med tiden.', href: null, icon: null, keywords: ['kedjeregeln', 'leibniz notation', 'derivata', 'förändringshastighet', 'relaterade förändringshastigheter', 'oljefläck', 'ballong', 'area', 'volym', 'klot'] },
{ num: '2.5', title: 'Derivatan av sin x och cos x', description: 'Trigonometriska funktioner deriveras: D(sin x) = cos x och D(cos x) = −sin x när vinkeln mäts i radianer. Kombineras med kedjeregeln, till exempel D(sin kx) = k cos kx.', href: null, icon: null, keywords: ['derivata', 'trigonometriska funktioner', 'sinus', 'cosinus', 'radianer', 'kedjeregeln', 'deriveringsregler', 'derivatan av sin x', 'derivatan av cos x'] },
{ num: '2.6', title: 'Derivatan av exponential- och logaritmfunktioner', description: 'Deriveringsreglerna D(e^kx) = k·e^kx, D(a^x) = a^x · ln a och D(ln x) = 1/x, kombinerade med kedjeregeln — samt D-skrivsättet och en härledning av derivatan till ln x.', href: null, icon: null, keywords: ['derivata','exponentialfunktion','logaritmfunktion','naturliga logaritmen','ln','kedjeregeln','deriveringsregler','e^x','a^x','D-notation'] },
{ num: '2.7', title: 'Produktregeln och kvotregeln', description: 'Derivera produkter med produktregeln y\' = f\'g + fg\' och kvoter med kvotregeln — samt härledning av derivatan för tan x med kvotregeln.', href: null, icon: null, keywords: ['derivata','produktregeln','kvotregeln','deriveringsregler','tangens','tan x','produkt','kvot','derivering','derivera'] },
{ num: '2.8', title: 'Tillämpningar med digitala verktyg', description: 'Definiera en funktion i Geogebra, läsa av derivatans värde f\'(a) och lösa f\'(x) = 0 grafiskt eller numeriskt med NLös — även för funktioner utan handregler.', href: null, icon: null, keywords: ['derivata', 'digitala verktyg', 'geogebra', 'nlös', 'nollställen', 'förändringshastighet', 'grafisk lösning', 'numerisk lösning', 'extrempunkt', 'tillämpning'] },
{ num: '2.9', title: 'Extremvärdesproblem (repetition)', description: 'Största och minsta värde med derivata — ställ upp funktionen, lös $f\'(x)=0$ och avgör karaktären med andraderivatan.', href: null, icon: null, keywords: ['derivata','extremvärdesproblem','optimering','största värde','minsta värde','maximum','minimum','andraderivatan','extrempunkt','terrasspunkt'] },
{ num: '2.10', title: 'Extremvärdesproblem med digitala hjälpmedel', description: 'Rita upp funktionen i GeoGebra och läs av maximi- och minimipunkter — och använd derivatans graf för att hitta den snabbaste förändringstakten.', href: null, icon: null, keywords: ['derivata','extremvärdesproblem','optimering','digitala hjälpmedel','geogebra','maximipunkt','minimipunkt','extrempunkt','förändringshastighet','maximal koncentration'] },
{ num: '2.11', title: 'Kurvkonstruktion med derivata', description: 'Skissa grafer med hjälp av derivatan: teckentabell, derivatans nollställen via nollproduktmetoden, extrempunkternas karaktär, terrasspunkter och ändpunkter i ett slutet intervall.', href: null, icon: null, keywords: ['derivata','kurvkonstruktion','teckentabell','nollproduktmetoden','extrempunkt','maximipunkt','minimipunkt','terrasspunkt','skissa graf','ändpunkt'] },
...
{ num: '2.S', title: 'Sammanfattning', description: 'Kedjeregeln, produkt- och kvotregeln, trigonometriska derivator och asymptoter — kapitlets regler och metoder komprimerat inför provet.', href: null, icon: null, keywords: ['sammanfattning','repetition','prov','provkoll','formler','derivata','deriveringsregler','kedjeregeln','produktregeln','kvotregeln','asymptoter'] },
          ...
          'Integraler': {
            number: 3,
            intro: 'Integralen vänder på derivatan. Vi börjar med primitiva funktioner och använder integraler för att beräkna arean under en kurva, mellan två kurvor och för att bestämma storheter ur förändringshastigheter. Täthetsfunktioner kopplar integralen till sannolikhet, och kapitlet avslutas med rotationskroppar — volymen av kroppar som bildas när en kurva roterar kring en axel.',
            sections: [
{ num: '3.1', title: 'Primitiva funktioner', description: 'Repetition av primitiv funktion och skrivsättet F(x), nya primitiva funktioner till e^(kx), sin x, cos x och 1/x, samt tillämpning där hastighet integreras till sträcka.', href: null, icon: null, keywords: ['primitiv funktion', 'integraler', 'integrering', 'F(x)', 'integrationskonstant', 'exponentialfunktion', 'logaritm', 'sträcka hastighet acceleration', 'raket', 'antiderivata'] },
{ num: '3.2', title: 'Areaberäkning med integraler', description: 'Integralen som area under en kurva, negativa areor och integralkalkylens fundamentalsats för att beräkna bestämda integraler.', href: null, icon: null, keywords: ['integral', 'area', 'bestämd integral', 'fundamentalsats', 'primitiv funktion', 'area under kurva', 'negativ integral', 'areaberäkning'] },
{ num: '3.3', title: 'Räkneregler för integraler', description: 'Bryt ut en konstant faktor, integrera summor och skillnader ledvis, foga ihop delintervall och byt tecken när gränserna kastas om.', href: null, icon: null, keywords: ['integraler','räkneregler','konstant faktor','summa','differens','delintervall','additivitet','integrationsgränser','bestämd integral'] },
{ num: '3.4', title: 'Arean mellan två kurvor', description: 'Arean mellan två kurvor som integralen av skillnaden övre minus undre funktion — bestäm skärningspunkterna som integrationsgränser och dela upp i flera integraler när fler kurvor begränsar området.', href: null, icon: null, keywords: ['area mellan kurvor','integral','bestämd integral','skärningspunkter','övre funktion','undre funktion','primitiva funktioner','pq-formeln','geogebra','integralmellan'] },
{ num: '3.5', title: 'Beräkning av storheter med integraler', description: 'Integralen av en förändringshastighet ger den ackumulerade storheten — sträcka ur hastighet, energi ur effekt — och integralens enhet är produkten av axlarnas enheter.', href: null, icon: null, keywords: ['integraler','tillämpningar','sträcka','hastighet','effekt','energi','integralens enhet','enhetsanalys','volym','förändringshastighet'] },
...
{ num: '3.S', title: 'Sammanfattning', description: 'Primitiva funktioner, areaberäkning, täthetsfunktioner och rotationskroppar — kapitlets begrepp, formler och metoder komprimerat inför provet.', href: null, icon: null, keywords: ['sammanfattning','repetition','prov','provkoll','formler','integraler','primitiv funktion','area','täthetsfunktion','rotationskropp'] },
          ...
          'Komplexa tal': {
            number: 4,
            intro: 'En ny talvärld öppnas när vi inför den imaginära enheten i, där i² = −1. Vi räknar med komplexa tal, löser andragrads- och polynomekvationer med komplexa rötter, och ritar talen som punkter och visare i det komplexa talplanet. Den polära formen gör multiplikation och division till vridningar, de Moivres formel ger potenser, och kapitlet kulminerar i ekvationen zⁿ = w och Eulers formel som binder samman exponentialfunktionen med trigonometrin.',
            sections: [
{ num: '4.1', title: 'Imaginära och komplexa tal', description: 'Den imaginära enheten i med i² = −1 gör att ekvationer som x² = −9 får lösningar. Komplexa tal på formen a + bi med realdel a och imaginärdel b, begreppen imaginärt och rent imaginärt tal, och lösning av ekvationer som x² = −64 och (x + 9)² = −49 med rotutdragning.', href: null, icon: null, keywords: ['komplexa tal','imaginära tal','imaginära enheten','i','realdel','imaginärdel','rent imaginärt tal','kvadratrot ur negativt tal','komplex rot','a + bi','talmängder'] },
{ num: '4.2', title: 'Beräkningar med komplexa tal', description: 'Realdel och imaginärdel, addition, subtraktion och multiplikation med i² = −1, konjugatet, samt division genom att förlänga bråket med nämnarens konjugat.', href: null, icon: null, keywords: ['komplexa tal','realdel','imaginärdel','konjugat','addition','subtraktion','multiplikation','division','identifikation','imaginära enheten'] },
{ num: '4.3', title: 'Andragradsekvationer med komplexa rötter', description: 'Lös fullständiga andragradsekvationer med *pq*-formeln när diskriminanten är negativ — rötterna blir då komplexkonjugerade a ± bi. Även *pq*-formeln med komplexa koefficienter och villkor för icke-reella rötter.', href: null, icon: null, keywords: ['komplexa tal','andragradsekvationer','pq-formeln','diskriminant','komplexa rötter','komplexkonjugat','icke-reella rötter','imaginära rötter','imaginära enheten'] },
{ num: '4.4', title: 'Polynomekvationer av högre grad och polynomdivision', description: 'Lös ekvationer av högre grad med faktorsatsen och nollproduktmetoden — bryt ut en känd faktor med polynomdivision, och komplexa rötter i konjugerade par.', href: null, icon: null, keywords: ['komplexa tal','polynomekvation','högre grad','faktorsatsen','polynomdivision','nollproduktmetoden','nollställe','tredjegradsekvation','faktorisering','konjugerade rötter'] },
{ num: '4.5', title: 'Komplexa tal som punkter och visare', description: 'Det komplexa talplanet — reella tal på Re-axeln, imaginära på Im-axeln, och komplexa tal som punkter eller visare. Addition och subtraktion sker som med vektorer.', href: null, icon: null, keywords: ['komplexa tal','komplexa talplanet','argand-diagram','visare','realdel','imaginärdel','re-axel','im-axel','konjugat','addition'] },
{ num: '4.6', title: 'Polär form', description: 'Rektangulär form z = a + bi jämförs med polär form z = r(cos v + i sin v). Absolutbeloppet r = |z| ger visarens längd och argumentet v dess vinkel, med rätt kvadrant. Omvandling mellan formerna och absolutbelopp som avstånd i talplanet.', href: null, icon: null, keywords: ['komplexa tal', 'polär form', 'rektangulär form', 'absolutbelopp', 'argument', 'visare', 'komplexa talplanet', 'argand', 'kvadrant'] },
{ num: '4.7', title: 'Multiplikation och division i polär form', description: 'Beloppen multipliceras och argumenten adderas — multiplikation blir en vridning plus skalning, och multiplikation med i är en 90°-vridning moturs.', href: null, icon: null, keywords: ['komplexa tal','polär form','multiplikation','division','argument','absolutbelopp','vridning','multiplikation med i'] },
