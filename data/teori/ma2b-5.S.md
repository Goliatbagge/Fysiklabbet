...
<!-- OBS: egen 2b-version, baserad på ma2c-5.S.md men UTAN logaritmer
     med andra baser (avsnittet ma2c-5.6 ingår inte i nivå 2b). Ändras
     kapitlets GEMENSAMMA innehåll i 2c-sammanfattningen: gör samma
     ändring här (bara sammanfattningarna för kapitel 2 och 5 är egna
     filer — allt annat delas via MA2B_ALIAS i data/katalog.js). -->
...
logaritmer och hantera logaritmekvationer.
