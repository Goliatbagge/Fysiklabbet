...
tillförlitligt sätt, och om hur man räknar på slumpens spel. Du har lärt
dig tolka och granska tabeller och diagram — frekvenstabeller, stapel-,
linje- och cirkeldiagram samt vilseledande diagram med avhuggna axlar —
och mött urvalsmetoder och felkällor, felmarginal och signifikans,
korrelation och kausalitet, samt fyra olika sätt att räkna ut
sannolikheter: den klassiska sannolikhetsdefinitionen, experimentell
sannolikhet, produktregeln med träddiagram och komplementhändelse. Du ska
efter kapitlet kunna granska en undersöknings tillförlitlighet och beräkna
sannolikheten för både enkla och sammansatta händelser.

## Begrepp att kunna

- **frekvens och relativ frekvens**: frekvensen är antalet gånger ett
  svar förekommer; den relativa frekvensen är frekvensen delad med det
  totala antalet, ofta angiven i procent. De relativa frekvenserna
  summerar alltid till 1 (100 %).
- **stapel-, linje- och cirkeldiagram**: stapeldiagram jämför
  kategorier, linjediagram visar en utveckling över tid och
  cirkeldiagram visar andelar av en helhet.
- **vilseledande diagram**: diagram som är korrekt ritade men ger en
  skev bild — vanligast genom en avhuggen *y*-axel som får små
  skillnader att se stora ut, men även genom vald tidsperiod, olika
  skalor och ytor i stället för höjder.
...
- Från andel till antal: andelen (den relativa frekvensen i decimalform)
  multiplicerad med det hela ger antalet — 45 % av 240 är
  $0{,}45 \cdot 240 = 108$.
- Granska alltid ett diagram innan du litar på det: var börjar axlarna,
  vilka skalor används och vilken tidsperiod är vald? En avhuggen
  *y*-axel jämför bara "stapelstumparna" ovanför brytpunkten — den
  verkliga förändringen fås ur kvoten mellan hela värdena.
...
**Skuggade rutor:** de 6 utfall av 36 möjliga som ger summan minst 10, dvs. $P(\text{summan} \geq 10) = \dfrac{6}{36} = \dfrac{1}{6}$.
:::
...
- Kan du läsa av en frekvenstabell, beräkna relativa frekvenser och
  välja rätt diagramtyp för olika slags data?
- Kan du avslöja ett vilseledande diagram — t.ex. en avhuggen *y*-axel —
  och beräkna den verkliga procentuella förändringen?
