...
window.SIM_NAMES = {
  ...
  'fysik2-dubbelspalt.html': [
    { name: 'Dubbelspaltexperimentet med observatör', desc: 'Skjut elektroner mot en dubbelspalt och se interferensmönstret växa fram, om ingen observerar dem. Aktivera observatören och se hur mönstret försvinner.',
      kw: ['modern fysik','kvantfysik','dubbelspalt','elektroner','interferens','våg-partikel','våg-partikeldualitet','de broglie','observation','observatör','mätning','kollaps'] },
    { name: 'Dubbelspalten i 3D', href: 'fysik2-dubbelspalt-3d-app.html', desc: 'Dubbelspaltexperimentet i 3D: en vågyta visar hur de två vågsystemen bakom spalterna förstärker och släcker ut varandra, och skärmen fångar mönstret, som ljusband eller som partiklar en i taget. Ändra våglängd, spaltavstånd och skärmavstånd, mät vägskillnaden med ett klick och se gitterformeln ritad i rummet.',
      kw: ['vågor','optik','ljus','diffraktion','interferens','dubbelspalt','enkelspalt','gitterformeln','laser','våglängd','spaltavstånd','spaltbredd','maxima','minima','nodlinje','vägskillnad','huygens','fotoner','elektroner','de broglie','kvantfysik','3d'] },
  ],
  'fysik2-dubbelspalt-3d-app.html': [
    { name: 'Dubbelspalten i 3D', desc: 'Dubbelspaltexperimentet i 3D: en vågyta visar hur de två vågsystemen bakom spalterna förstärker och släcker ut varandra, och skärmen fångar mönstret, som ljusband eller som partiklar en i taget. Ändra våglängd, spaltavstånd och skärmavstånd, mät vägskillnaden med ett klick och se gitterformeln ritad i rummet.',
      kw: ['vågor','optik','ljus','diffraktion','interferens','dubbelspalt','enkelspalt','gitterformeln','laser','våglängd','spaltavstånd','spaltbredd','maxima','minima','nodlinje','vägskillnad','huygens','fotoner','elektroner','de broglie','kvantfysik','3d'] },
    { name: 'Dubbelspaltexperimentet med observatör', href: 'fysik2-dubbelspalt.html', desc: 'Skjut elektroner mot en dubbelspalt och se interferensmönstret växa fram, om ingen observerar dem. Aktivera observatören och se hur mönstret försvinner.',
      kw: ['modern fysik','kvantfysik','dubbelspalt','elektroner','interferens','våg-partikel','våg-partikeldualitet','de broglie','observation','observatör','mätning','kollaps'] },
  ],
