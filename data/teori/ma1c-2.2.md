...
När vi skriver ett uttryck på ett enklare sätt kallas det att **förenkla
uttryck**.
...
**b)** Vi kan bara lägga ihop $x^2$-termer för sig och $x$-termer för sig:
...
$$
20x - (5 + 3x - 7y) = 20x - 5 - 3x + 7y = 17x - 5 + 7y
$$
