        ...
        chapters: {
          'Rörelse och krafter': {
            ...
            sections: [
              ...
              { num: '1.2', title: 'Mer kraftmoment', description: 'En bräda på två bockar. Dra i lasten och i stöden och se stödkrafterna F_P och F_Q live. Välj vridningspunkt fritt (vid ett stöd blir dess hävarm 0) och lös ut den andra kraften med momentlagen — och se brädan välta när tyngdpunkten passerar ett stöd.', href: 'fysik2-brada-tva-stod-app.html', href2: 'fysik2-gaffelbalans-app.html', href3: 'fysik2-dubbelkon-app.html', icon: '⚖️', keywords: ['krafter','moment','vridmoment','kraftmoment','exempel','jämvikt','vridningspunkt','stöd','stödkraft','bock','bräda','hävarm','tyngdpunkt','stabilitet','vältning','statik','mekanik','gaffel','balans','balanstrick','kork','nål','mynt','dubbelkon','rullar uppför'] },
              ...
              { num: '1.7', title: 'Exempel — Den flygande kossan', description: 'Räkneexempel: snett kast och rörelseanalys.', href: null, icon: '🐄', keywords: ['rörelse','kast','exempel','projektil'] },
